  ...
  module Messenger
    ...
    module Bot
      ...
      class << self
        ...
        def broadcast(message_creative_id:, label_id: nil, targeting_labels: nil)
          ...
          response = post '/broadcast_messages', body: JSON.dump(message_creative_id: message_creative_id, **label_data), format: :json
          raise_errors_from(response)
